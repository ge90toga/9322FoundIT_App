...
package com.comp9322.seek.commandline;

import java.util.*;

import com.comp9322.seek.service.PostService;
...
//        userService.createUser(new UserDTO("ruan.yuji@gmail.com", "123", "yuji"));
//        userService.createUser(new UserDTO("test@gmail.com", "123", "test"));
//        userService.createAdmin(new UserDTO("295046974@qq.com", "123", "frank"));
	}
