...
import com.seek.api.filters.StatelessAuthenticationFilter;
import com.seek.api.filters.StatelessLoginFilter;
import com.seek.api.security.TokenAuthenticationService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, "/api/admin/poll").hasRole("ADMIN")
